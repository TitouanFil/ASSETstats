...
ClowlandLaos <- read_dta("d2_1_lowland.dta")
CuplandLaos <- read_dta("d2_2_upland.dta")
...
#C49 = OK
#C50 = OK
#C51 = FACT, (We don't have the correspondance for this question in the questionaire...)
...
#C60 = NI
#C61 = NUMERIC
#C62 = FACT, (99 = other, 88 = do not know)
...
#C193 = FACT, (Table of correspondence)
...
#C552 = FACT, (Table of correspondence)
...
#C566 = FACT, (Table of correspondence), replace label: "c5. what is your role / responsibility in the c3a"
...
#C674 = FACT, empty, replace label: "Inputs (sold)"
var_label(HouseholdLaos$b14_10) <- "Inputs (sold)"
#C675 = FACT, empty, replace label: "Inputs on credit"
var_label(HouseholdLaos$b14_11) <- "Inputs on credit"
#C676 = FACT, empty, replace label: "Cash credit"
var_label(HouseholdLaos$b14_12) <- "Cash credit"
#C677 = FACT, empty, replace label: "Technical advice/training"
var_label(HouseholdLaos$b14_13) <- "Technical advice/training"
#C678 = FACT, empty, replace label: "Market information "
var_label(HouseholdLaos$b14_14) <- "Market information "
#C679 = FACT, empty, replace label: "Regular sales"
var_label(HouseholdLaos$b14_15) <- "Regular sales"
#C680 = FACT, empty, UNKNOWN, replace label: "??"
var_label(HouseholdLaos$b14_16) <- "??"
...
#C684 = FACT, (Table of correspondence), replace label: "b15_1. do you have a contract with b12_1"
...
var_label(HouseholdLaos$d21_122_a) <- "d21_112. for which crop(s) do you use crop Mowing / slashing"
...
var_label(HouseholdLaos$d21_123_a) <- "d21_113. what was your main motivation to implement crop Mowing / slashing"
#C1435 = OK, (empty)

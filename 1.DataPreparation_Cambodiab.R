...
HouseholdCambodia2 <- read.csv("HouseholdCambodia2.csv", sep = ";")
HouMemberCambodia2 <- read.csv("HouMemberCambodia2.csv", sep = ";")
ClowlandCambodia2 <- read.csv("ClowlandCambodia2.csv", sep = ";")
CuplandCambodia2 <- read.csv("CuplandCambodia2.csv", sep = ";")
HomegardenCambodia2 <- read.csv("HomegardenCambodia2.csv", sep = ";")
#HouseholdCambodia2b <- HouseholdCambodia2
#HouMemberCambodia2b <- HouMemberCambodia2
#ClowlandCambodia2b <- ClowlandCambodia2
#CuplandCambodia2b <- CuplandCambodia2
#HomegardenCambodia2b <- HomegardenCambodia2

#We check for columns correspondences and re-adjust when it is necesary
#First for Household Cambodia database
HouseholdCambodia2 <- HouseholdCambodia2[,-c(1,10:11,57,91,124,162,208,366,389,474,489,
                                             507:509,512,527,534,552,586,655,659,689,718,
                                             748,802,805,810,813,816,916,951,997,1150,
                                             1374,1634,1654,2121,2135,2153,2158,2253,2311,
                                             2322,2391,2393,2424,2447,2450,2452,2553,2565,
                                             2570)]
HouseholdCambodia2$Dummy <- 1
HouseholdCambodia2 <- HouseholdCambodia2 %>% relocate(Dummy , .after = b12_1text)
HouseholdCambodia2 <- HouseholdCambodia2 %>% relocate(Reasons.for.not.selling.to.cooperative..English , .after = b24_15a..For.certified.cassava..which.were.the.buyers.outlets.in.2022.Other)
HouseholdCambodia2 <- HouseholdCambodia2 %>% relocate(Reasons.not.to.sell.cooperative...English , .after = b24_16a..For.certified.cashew.nut..which.were.the.buyers.outlets.in.2022.Do.not.know..No.selling..No.the.second.outlet)
HouseholdCambodia2 <- HouseholdCambodia2 %>% relocate(b12_2..What.is.the.second.outlet..buyer., .after = b15_1..Do.you.have.a.contract.with..strong...font.color..green....b12_1text.....b12_1name...font....strong..)
HouseholdCambodia2 <- HouseholdCambodia2 %>% relocate(b12_2name...English, .after = b12_2..What.is.the.second.outlet..buyer.)
HouseholdCambodia2 <- HouseholdCambodia2 %>% relocate(b12_2text, .after = b12_2name...English)
HouseholdCambodia2$Dummy2 <- 1
HouseholdCambodia2 <- HouseholdCambodia2 %>% relocate(Dummy2 , .after = b12_2text)
#For Household members database
HouMemberCambodia2 <- HouMemberCambodia2[,-c(2,5,6)]
#For Lowland crops database
ClowlandCambodia2 <- ClowlandCambodia2[,-c(2,5,6)]
#For upland crops database
CuplandCambodia2 <- CuplandCambodia2[,-c(2,5,6,26:28)]
CuplandCambodia2 <- CuplandCambodia2 %>% relocate(Reasons.why.too.low.yield , .after = X_submission__tags)
#For homegarden database
HomegardenCambodia2 <- HomegardenCambodia2[,-c(2,5,6)]

#List creation to check if columns are similar or not
#x <- rbind(var_label(HouseholdCambodia),colnames(HouseholdCambodia2)[1:2574])
#y <- rbind(var_label(HouMemberCambodia),colnames(HouMemberCambodia2)[1:77])
#z <- rbind(var_label(ClowlandCambodia),colnames(ClowlandCambodia2)[1:37])
#a <- rbind(var_label(CuplandCambodia),colnames(CuplandCambodia2)[1:33])
#b <- rbind(var_label(HomegardenCambodia),colnames(HomegardenCambodia2)[1:33])

#We re-attribute names of databases
#First for Household Cambodia database
colnames(HouseholdCambodia2) <- colnames(HouseholdCambodia)[1:ncol(HouseholdCambodia2)]
HouseholdCambodia2 <- copy_labels(HouseholdCambodia2, HouseholdCambodia)
HouseholdCambodia <- HouseholdCambodia2
#For Household members database
colnames(HouMemberCambodia2) <- colnames(HouMemberCambodia)
HouMemberCambodia2 <- copy_labels(HouMemberCambodia2, HouMemberCambodia)
HouMemberCambodia <- HouMemberCambodia2
#For Lowland crops database
colnames(ClowlandCambodia2) <- colnames(ClowlandCambodia)
ClowlandCambodia2 <- copy_labels(ClowlandCambodia2, ClowlandCambodia)
ClowlandCambodia <- ClowlandCambodia2
#For upland crops database
colnames(CuplandCambodia2) <- colnames(CuplandCambodia)
CuplandCambodia2 <- copy_labels(CuplandCambodia2, CuplandCambodia)
CuplandCambodia <- CuplandCambodia2
#For Homegarden  database
colnames(HomegardenCambodia2) <- colnames(HomegardenCambodia)
HomegardenCambodia2 <- copy_labels(HomegardenCambodia2, HomegardenCambodia)
HomegardenCambodia <- HomegardenCambodia2
...
#C36 = FACT
#C37 = FACT, ASK KY TO GET THE REAL VALUES, NOT POSSIBLE TO GET THEM UNDER THIS FORMAT
...
#C54 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C55 = FACT
#C56 = FACT
...
#C87 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C118 = OK, (the answer is still in Vietnamese, Ky will maybe solve it) -SOLVED English
...
#C155 = CHAR, (empty)
#C156 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C201 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C374 = OK, (the answer is still in Khmer, Ky will maybe solve it), replace label: "Other. Specify" - SOLVED English
var_label(HouseholdCambodia$b24_15a_reason) <- "b25_15a - Other. Specify"
#C375 = OK, (empty)
...
#C396 = OK, (the answer is still in Khmer, Ky will maybe solve it), replace label: "Other. Specify" - SOLVED English
var_label(HouseholdCambodia$b24_16a_reason) <- "b24_16a - Other. Specify"
#C397 = OK, (empty)
...
#C476 = OK, (empty)
#C477 = FACT, (bin)
#C478 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C479 = FACT, (bin)
#C480 = FACT, (bin)
...
#C495 = FACT
#C496 = FACT
#C497 = OK, (the answer is still in Khmer, Ky will maybe solve it) -SOLVED English
...
#C511 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C513 = OK, (the answer is still in Khmer, Ky will maybe solve it), replace label: "Specify" - SOLVED English
...
#C517 = OK, (the answer is still in Khmer, Ky will maybe solve it), replace label: "c5_oth. specify your other role in the c3a" - SOLVED English
...
#C531 = OK, (the answer is still in Khmer, Ky will maybe solve it), replace label: "Specify other" - SOLVED English
...
#C567 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English 
...
#C598 = NUMERIC,
#C599 = NUMERIC, we remove the spaces
HouseholdCambodia[,599] <- str_remove_all(HouseholdCambodia[,599]," ")
...
#C609 = NUMERIC,
#C610 = NUMERIC,
HouseholdCambodia[,610] <- str_remove_all(HouseholdCambodia[,610]," ")
...
#C616 = OK, (empty)
#C617 = NUMERIC,
#C618 = NUMERIC, we remove the spaces
HouseholdCambodia[,618] <- str_remove_all(HouseholdCambodia[,618]," ")
...
#C635 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C636 = OK, (the answer is still in Khmer, Ky will maybe solve it)
#C637 = CHAR, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C696 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English, replace label: "b14_2oth. specify other provision from b12_2"
...
#C725 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C726 = NUMERIC
#C727 = FACT, (bin)
#C728 = OK, (empty)
#C729 = NUMERIC
...
#Do not know
#Other
#C778 = OK, replace label: "d81_1a_oth. specify other reason for planting d81_text", (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#Do not know
#Other
#C780 = OK, replace label: "d81_1b_oth. specify other constrain for d81_text", (the answer is still in Khmer, Ky will maybe solve it) -  SOLVED English
...
#C782 = OK, replace label: "d82_1a_oth. specify other reason for planting d82_text", (the answer is still in Khmer, Ky will maybe solve it) -  SOLVED English
...
#C784 = OK, replace label: "d82_1b_oth. specify other constrain for d82_text", (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C786 = OK, replace label: "d83_1a_oth. specify other reason for planting d83_text", (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C788 = OK, replace label: "d83_1b_oth. specify other constrain for d83_text", (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C887 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C921 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C966 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C1118 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C1341 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C1596 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C1619 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#Other
#Do not know/ no the second outlet
#C2085 = OK, (the answer is still in Khmer, Ky will maybe solve it), (real name) - SOLVED English
...
#C2098 = OK, (the answer is still in Khmer, Ky will maybe solve it), replace label: "b20_1oth. specify other provision from b18_1text" - SOLVED English
...
#Other
#Do not know/ no the second outlet
#C2115 = OK, (the answer is still in Khmer, Ky will maybe solve it), (real name) - SOLVED English
...
#Other
#Do not know
#C2119 = OK, (the answer is still in Khmer, Ky will maybe solve it), replace label: "b20_2oth. specify other provision from b18_2text" - SOLVED English
...
#Others
#C2213 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#Do not know
#Others
#C2270 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C2271 = FACT, (bin)
...
#Already include in the feed
#Others
#C2280 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#Already include in the feed
#Others
#C2348 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C2349 = FACT, (bin)
...
# # #f.
#C2378 = FACT, (bin)
#C2379 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C2401 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C2402 = FACT, (bin)
#C2403 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C2404 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C2504 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
...
#C2515 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C2516 = FACT, (bin)
#C2517 = FACT, (bin)
...
#C2519 = OK, (the answer is still in Khmer, Ky will maybe solve it) - SOLVED English
#C2520 = OK
#C2521 = OK
...
#C11 = NUM, replace label: "Age (years)", empty, we add the values
var_label(HouMemberCambodia$a4_1) <- "Age (years)"
HouMemberCambodia$a4_1 <- 2023-HouMemberCambodia$a4
...
#C64 = OK, (empty)
#C65 = OK, (empty)
#C66 = FACT, REMOVE, (empty, correspond to nothing in the questionnaire)
#C67 = REMOVE, (empty, correspond to nothing in the questionnaire)
#C68 = FACT, FACT, REMOVE, (empty, correspond to nothing in the questionnaire)
...
HouseholdCambodia[,12] <- str_remove_all(HouseholdCambodia[,12]," ")
...
for (i in c(1:3,7:9,11,13:34,36:42,48:53,55:57,60:65,68:78,80:86,88:91,93,96:117,120,122,124,131,133:154,
...
for (i in c(1:3,5,9,11,13:14,16:17,20,22:28)){
...
for (i in (Dum$o9)){
  ...
  for (j in 1:ncol(HouseholdCambodia_2C)){
    ifelse(is.na(Temp[1,j]) | Temp[1,j] == '', Temp[1,j] <- Temp[2,j], Temp[1,j] <- Temp[1,j])
  }
...
HouseholdCambodia_2C <- HouseholdCambodia_2C[!rownames(HouseholdCambodia_2C) == "45",]
#Check again the duplicates: 
count_if("TRUE",duplicated(HouseholdCambodia_2C$o9))

x <- HouseholdCambodia[,c(18,797)]

# # #b Outliers

#d2_15 - One household have 100ha of lowland plot, it seems strange => REMOVE
HouseholdCambodia_2C$d2_15 <- as.character(HouseholdCambodia_2C$d2_15)
HouseholdCambodia_2C$d2_15 <- ifelse(HouseholdCambodia_2C$d2_15 == 1000000, NA, HouseholdCambodia_2C$d2_15)
HouseholdCambodia_2C$d2_15 <- as.numeric(HouseholdCambodia_2C$d2_15)

#d5_2 - One household have 10000 plots of forest land => Replace by 1
#as household has only 400 m² of forest land
HouseholdCambodia_2C$d5_2 <- as.character(HouseholdCambodia_2C$d5_2)
HouseholdCambodia_2C$d5_2 <- ifelse(HouseholdCambodia_2C$d5_2 == 10000, 1, HouseholdCambodia_2C$d5_2)
HouseholdCambodia_2C$d5_2 <- as.numeric(HouseholdCambodia_2C$d5_2)

#d6_3 - One household have 25ha of aquaculture => REMOVE
HouseholdCambodia_2C$d6_3 <- as.character(HouseholdCambodia_2C$d6_3)
HouseholdCambodia_2C$d6_3 <- ifelse(HouseholdCambodia_2C$d6_3 == 25000, 1, HouseholdCambodia_2C$d6_3)
HouseholdCambodia_2C$d6_3 <- as.numeric(HouseholdCambodia_2C$d6_3)

#d9_3 - It seems strange that one household has 100 ha of rented in area => REMOVE
HouseholdCambodia_2C$d9_3 <- as.character(HouseholdCambodia_2C$d9_3)
HouseholdCambodia_2C$d9_3 <- ifelse(HouseholdCambodia_2C$d9_3 == 1000000, 1, HouseholdCambodia_2C$d9_3)
HouseholdCambodia_2C$d9_3 <- as.numeric(HouseholdCambodia_2C$d9_3)

#d11_2 - One household has 35000 plots => Replace by 1
HouseholdCambodia_2C$d11_2 <- as.character(HouseholdCambodia_2C$d11_2)
HouseholdCambodia_2C$d11_2 <- ifelse(HouseholdCambodia_2C$d11_2 == 35000, 1, HouseholdCambodia_2C$d11_2)
HouseholdCambodia_2C$d11_2 <- as.numeric(HouseholdCambodia_2C$d11_2)
summary(HouseholdCambodia_2C$d11_2)


# # #c. Corresponding fields
#The following part is based on Cambodia script but we removed all parts for which
#no issue was highligted for Cambodia, assuming no issue was permitted by Kobo for 
#these fields

#For all following fields, we just check that answers are corresponding
#a14:a15
sum(HouseholdCambodia_2C$a14 >0)-sum(HouseholdCambodia_2C$a15 != '')
#OK
#b2:b2_1:b2_2
x <- HouseholdCambodia_2C[,c(81,82,88)]
#OK
#b3: b31-b388
#OK
#b4_1: b5_1
sum(HouseholdCambodia_2C$b4_1 !='')-sum(!is.na(HouseholdCambodia_2C$b5_1))
#OK
#b4_2: b5_2
sum(HouseholdCambodia_2C$b4_2 !='')-sum(!is.na(HouseholdCambodia_2C$b5_2))
#OK
#b4_3: b5_3
sum(HouseholdCambodia_2C$b4_3 !='')-sum(!is.na(HouseholdCambodia_2C$b5_3))
#OK
#b6: b7: b8: b8_1: b9: b9_1: b9_2.: b9_3
#OK
#b1:b10:b11
#2 households answered while they are not selling crops/vegetables, we replace their answers by ""
x <- HouseholdCambodia_2C[,c(1,80,211,221)]
HouseholdCambodia_2C$b10 <- as.character(HouseholdCambodia_2C$b10)
HouseholdCambodia_2C$b10 <- ifelse(HouseholdCambodia_2C$b1 ==	"Selling own livestock products",
                                   "",HouseholdCambodia_2C$b10)
HouseholdCambodia_2C$b10 <- as.factor(HouseholdCambodia_2C$b10)
HouseholdCambodia_2C$b11 <- as.character(HouseholdCambodia_2C$b11)
HouseholdCambodia_2C$b11 <- ifelse(HouseholdCambodia_2C$b1 ==	"Selling own livestock products",
                                   "",HouseholdCambodia_2C$b11)
HouseholdCambodia_2C$b11 <- as.factor(HouseholdCambodia_2C$b11)
#3 households declared that they sold crops products but did not anwered to b10 & b11
#HHID: 2458, 2672, 2679
#As we cannot know their answer, we cannot solve this issue => ASK ENUM
#b10:b10_1
#OK
#b1:b16:b17
x <- HouseholdCambodia_2C[,c(1,80,222,224)]
#1 household answered while they are not selling animal products
#we replace their answers by "" (HHID: 2679)
HouseholdCambodia_2C$b16 <- as.character(HouseholdCambodia_2C$b16)
HouseholdCambodia_2C$b16 <- ifelse(HouseholdCambodia_2C$b1 ==	"Selling own crops/fruits/ vegetable",
                                   "",HouseholdCambodia_2C$b16)
HouseholdCambodia_2C$b16 <- as.factor(HouseholdCambodia_2C$b16)
HouseholdCambodia_2C$b17 <- as.character(HouseholdCambodia_2C$b17)
HouseholdCambodia_2C$b17 <- ifelse(HouseholdCambodia_2C$b1 ==	"Selling own crops/fruits/ vegetable",
                                   "",HouseholdCambodia_2C$b17)
HouseholdCambodia_2C$b17 <- as.factor(HouseholdCambodia_2C$b17)
#Moreover, 4 households declared that they sold animal products but did not answered to b16 & b17
#HHID: 2203,2417,2458,2303
#As we cannot know their answer, we cannot solve this issue => ASK ENUM
#b16:b16a
#OK
#b1:b22
x <- HouseholdCambodia_2C[,c(80,225)]
#OK
#b22:b22_1:b22_11-b22_199:b25:b26
x <- HouseholdCambodia_2C[,c(1,225,259:268,462,463)]
#OK
#(b23_1a-b24_1b)
#b27:b27_1:b27_11-b27:188
#OK
#b28:b28_1
#Many missing answers to b28_1
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#c2:c3:c3a:c4:c5:c9:c6:c7:c8:c10:c11
x <- HouseholdCambodia_2C[,c(1,498,499,512,514,516,518,532:536)]
#OK
#d1:d1_1-d1_7
#OK
...
#OK
#b1:b12_1:b12_2
x <- HouseholdCambodia_2C[,c(1,80,634,666)]
#3 households declared at b1 that they sold agri products but did not answered ar b12_1 and b12_2
#HHid: 2287,2717,2187
#As we cannot know their answer, we cannot solve this issue - ASK ENUM
#b12_1:b13_1:b13_01-b13_0111:b14_1-b14_188:b15_1
x <- HouseholdCambodia_2C[,c(1,634,638,652:665)]
#Some crops are missing, HHid: 2487, 2318, 2087
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#b12_2:b13_02-b13_0211:b13_2:b14_2-b14_288:b15_2
x <- HouseholdCambodia_2C[,c(1,666,685,697)]
#For b13_02 and related answers => First, the initial use of columns was modified,
#Here we have one crop per cell starting from b13_02 and in the following ones
#HHid 2199,2162,2248,2224,2324 answered while they declared no 2nd outlet/buyer -> ASK ENUM
#HHid 2551 did not answered while they declared a second outlet/buyer -> ASK ENUM
#d1:d3_2:d3_3
x <- HouseholdCambodia_2C[,c(1,581,698,699)]
#OK
#d1:d4_2:d4_3
x <- HouseholdCambodia_2C[,c(1,581,700,701)]
#OK
#d1:d5_2:d5_3
x <- HouseholdCambodia_2C[,c(1,581,704,705)]
#OK
#d1:d6_2:d6_3
x <- HouseholdCambodia_2C[,c(1,581,706,707)]
#OK
#d7-d799
x <- HouseholdCambodia_2C[,c(1,708:724)]
#OK
#d71:d7_11:d7_12:d7:13
x <- HouseholdCambodia_2C[,c(1,710,726:728)]
#OK
#d72:d7_21:d7_22:d7:23
x <- HouseholdCambodia_2C[,c(1,711,729:731)]
#OK
#d73:d7_31:d7_32:d7:33
x <- HouseholdCambodia_2C[,c(1,712,732:734)]
#OK
#d74:d7_41:d7_42:d7:43
x <- HouseholdCambodia_2C[,c(1,713,735:737)]
#OK
#d75:d7_51:d7_52:d7:53
x <- HouseholdCambodia_2C[,c(1,714,738:740)]
#OK
#d76:d7_61:d7_62:d7:63
x <- HouseholdCambodia_2C[,c(1,715,741:743)]
#OK
#d77:d7_71:d7_72:d7:73
x <- HouseholdCambodia_2C[,c(1,716,744:746)]
#OK
#d78:d7_81:d7_82:d7:83
x <- HouseholdCambodia_2C[,c(1,717,747:749)]
#OK
#d79:d7_91:d7_92:d7:93
x <- HouseholdCambodia_2C[,c(1,718,750:752)]
#OK
#d711:d7_111:d7_112:d7:113
x <- HouseholdCambodia_2C[,c(1,719,753:755)]
#OK
#d714:d7_141:d7_142:d7:143
x <- HouseholdCambodia_2C[,c(1,720,756:758)]
#OK
#d716:d7_161:d7_162:d7:163
x <- HouseholdCambodia_2C[,c(1,721,759:761)]
#OK
#d717:d7_171:d7_172:d7:173
x <- HouseholdCambodia_2C[,c(1,722,762:764)]
#OK
#d718:d7_181:d7_182:d7:183
x <- HouseholdCambodia_2C[,c(1,723,765:767)]
#OK
#d799:d7_991:d7_992:d7:993
x <- HouseholdCambodia_2C[,c(1,724,768:770)]
#OK
#d2a_1:d2b_1:d2c_1:d81:d81_1a:d81_1b
x <- HouseholdCambodia_2C[,c(1,590,600,611,771,777,779)]
#OK
#d2a_1:d2b_1:d2c_1:d82:d82_1a:d82_1b
x <- HouseholdCambodia_2C[,c(1,590,600,611,772,781,783)]
#OK
#d2a_1:d2b_1:d2c_1:d83:d83_1a:d83_1b
x <- HouseholdCambodia_2C[,c(1,590,600,611,773,785,787)]
#OK
#d9_1:d9_2:d9_3
x <- HouseholdCambodia_2C[,c(1,790:792)]
#OK
#d10_1:d10_2
x <- HouseholdCambodia_2C[,c(1,793,794)]
#OK
#d11_1:d11_2:d11_4-d11_499
#OK
#d2a_1:d2b_1:d2c_1 :d12-d120
x <- HouseholdCambodia_2C[,c(1,590,600,611,808:818)]
#OK
#d121:d131_1:d131_11-d131_111:d131_2
sum(HouseholdCambodia_2C$d121 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d131_1 != '')
for (i in c(821:834)){
  print(sum(HouseholdCambodia_2C$d121 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d121 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d131_2 != '')
#OK
#d122:d132_1:d132_11-d132_111:d132_2
#No household having this practice = OK
#d123:d133_1:d133_11-d133_111:d133_2
sum(HouseholdCambodia_2C$d123 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d133_1 != '')
for (i in c(855:868)){
  print(sum(HouseholdCambodia_2C$d123 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d123 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d133_2 != '')
#OK
#d124:d134_1:d134_11-d134_111:d134_2
sum(HouseholdCambodia_2C$d124 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d134_1 != '')
for (i in c(872:885)){
  print(sum(HouseholdCambodia_2C$d124 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d124 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d134_2 != '')
# For 23 households, they declared yes to the practice but no information about the crop
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#d125:d135_1:d135_11-d135_111:d135_2
sum(HouseholdCambodia_2C$d125 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d135_1 != '')
for (i in c(889:902)){
  print(sum(HouseholdCambodia_2C$d125 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d125 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d135_2 != '')
#For 1 household, they declared yes to the practice but no information about the crop
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#d126:d136_1:d136_11-d136_111:d136_2
sum(HouseholdCambodia_2C$d126 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d136_1 != '')
for (i in c(906:919)){
  print(sum(HouseholdCambodia_2C$d126 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d126 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d136_2 != '')
# For 16 household, they declared yes to the practice but no information about the crop
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#d127:d137_1:d137_11-d137_111:d137_2
sum(HouseholdCambodia_2C$d127 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d137_1 != '')
for (i in c(923:936)){
  print(sum(HouseholdCambodia_2C$d127 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d127 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d137_2 != '')
# For 3 household, they declared '' to the practice but add a crop
#We'll replace '' by 'yes' in this case
HouseholdCambodia_2C$d127 <- as.character(HouseholdCambodia_2C$d127)
HouseholdCambodia_2C$d127 <- ifelse(HouseholdCambodia_2C$d137_1 != '',1,HouseholdCambodia_2C$d127)
HouseholdCambodia_2C$d127 <- as.factor(HouseholdCambodia_2C$d127)
#d1299:d138_1:d138_11-d138_111:d138_2
sum(HouseholdCambodia_2C$d1299 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d138_1 != '')
for (i in c(940:953)){
  print(sum(HouseholdCambodia_2C$d1299 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d1299 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d138_2 != '')
#d2a_1:d2b_1:d2c_1 :d14-d1499
x <- HouseholdCambodia_2C[,c(1,590,600,611,956:965)]
#OK
#d141:d151_1:d151_11-d151_111:d151_2
sum(HouseholdCambodia_2C$d141 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d151_1 != '')
for (i in c(968:981)){
  print(sum(HouseholdCambodia_2C$d141 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d141 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d151_2 != '')
#d142:d152_1:d152_11-d152_111:d152_2
sum(HouseholdCambodia_2C$d142 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d152_1 != '')
for (i in c(985:998)){
  print(sum(HouseholdCambodia_2C$d142 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d142 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d152_2 != '')
#d143:d153_1:d153_11-d153_111:d153_2
sum(HouseholdCambodia_2C$d143 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d153_1 != '')
for (i in c(1002:1015)){
  print(sum(HouseholdCambodia_2C$d143 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d143 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d153_2 != '')
#For 20 household, they declared yes to the practice but no information about the crop
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#d144:d154_1:d154_11-d154_111:d154_2
sum(HouseholdCambodia_2C$d144 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d154_1 != '')
for (i in c(1019:1032)){
  print(sum(HouseholdCambodia_2C$d144 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d144 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d154_2 != '')
# For 44 households, they declared '' to the practice but add a crop
#We'll replace '' by 'yes' in this case
HouseholdCambodia_2C$d144 <- as.character(HouseholdCambodia_2C$d144)
HouseholdCambodia_2C$d144 <- ifelse(HouseholdCambodia_2C$d154_1 != '',1,HouseholdCambodia_2C$d144)
HouseholdCambodia_2C$d144 <- as.factor(HouseholdCambodia_2C$d144)
#d145:d155_1:d155_11-d155_111:d155_2
sum(HouseholdCambodia_2C$d145 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d155_1 != '')
for (i in c(1036:1049)){
  print(sum(HouseholdCambodia_2C$d145 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d145 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d155_2 != '')
#For 4 household, they declared yes to the practice but no information about the crop
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#d146:d156_1:d156_11-d156_111:d156_2
sum(HouseholdCambodia_2C$d146 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d156_1 != '')
for (i in c(1053:1066)){
  print(sum(HouseholdCambodia_2C$d146 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d146 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d156_2 != '')
#OK
#d147:d157_1:d157_11-d157_111:d157_2
sum(HouseholdCambodia_2C$d147 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d157_1 != '')
for (i in c(1070:1083)){
  print(sum(HouseholdCambodia_2C$d147 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d147 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d157_2 != '')
#OK
#d1499:d158_1:d158_11-d158_111:d158_2
sum(HouseholdCambodia_2C$d1499 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d158_1 != '')
for (i in c(1087:1100)){
  print(sum(HouseholdCambodia_2C$d1499 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d1499 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d158_2 != '')
#OK
#d2a_1:d2b_1:d2c_1:d120:d16
x <- HouseholdCambodia_2C[,c(1,590,600,611,818,1103)]
#OK
#d2a_1:d2b_1:d2c_1:d17:d18:d181-d1899
x <- HouseholdCambodia_2C[,c(1,590,600,611,1104:1117)]
#OK
#d181:d18_11:d18_111- d18_1111:d18_12
sum(HouseholdCambodia_2C$d181 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_11 != '')
for (i in c(1120:1133)){
  print(sum(HouseholdCambodia_2C$d181 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d181 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_12 != '')
#OK
#d182:d18_21:d18_211- d18_2111:d18_22
sum(HouseholdCambodia_2C$d182 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_21 != '')
for (i in c(1137:1150)){
  print(sum(HouseholdCambodia_2C$d182 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d182 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_22 != '')
#OK
#d183:d18_31:d18_311- d18_3111:d18_32
#No household implemented this practice
#d184:d18_41:d18_411- d18_4111:d18_42
sum(HouseholdCambodia_2C$d184 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_41 != '')
for (i in c(1171:1184)){
  print(sum(HouseholdCambodia_2C$d184 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d184 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_42 != '')
#OK
#d185:d18_51:d18_511- d18_5111:d18_52
sum(HouseholdCambodia_2C$d185 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_51 != '')
for (i in c(1188:1201)){
  print(sum(HouseholdCambodia_2C$d185 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d185 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_52 != '')
#OK
#d186:d18_61:d18_611- d18_6111:d18_62
sum(HouseholdCambodia_2C$d186 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_61 != '')
for (i in c(1205:1218)){
  print(sum(HouseholdCambodia_2C$d186 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d186 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_62 != '')
#OK
#d187:d18_71:d18_711- d18_7111:d18_72
sum(HouseholdCambodia_2C$d187 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_71 != '')
for (i in c(1222:1235)){
  print(sum(HouseholdCambodia_2C$d187 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d187 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_72 != '')
#OK
#d188:d18_81:d18_811- d18_8111:d18_82
sum(HouseholdCambodia_2C$d188 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_81 != '')
for (i in c(1239:1252)){
  print(sum(HouseholdCambodia_2C$d188 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d188 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_82 != '')
#OK
#d189:d18_91:d18_911- d18_9111:d18_92
sum(HouseholdCambodia_2C$d189 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_91 != '')
for (i in c(1256:1269)){
  print(sum(HouseholdCambodia_2C$d189 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d189 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_92 != '')
#OK
#d1810:d18_101:d18_1011- d18_10111:d18_102
sum(HouseholdCambodia_2C$d1810 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_101 != '')
for (i in c(1273:1286)){
  print(sum(HouseholdCambodia_2C$d1810 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d1810 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_102 != '')
#OK
#d1811:d18_111:d18_1111- d18_11111:d18_112_a
#No household implemented this practice
#d1899:d18_991:d18_9911- d18_99111:d18_992
sum(HouseholdCambodia_2C$d1899 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_991 != '')
for (i in c(1307:1320)){
  print(sum(HouseholdCambodia_2C$d1899 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d1899 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d18_992 != '')
#OK
#d2a_1:d2b_1:d2c_1:d20:d21:d211-d2199
x <- HouseholdCambodia_2C[,c(1,590,600,611,1324,1325:1340)]
#OK
#d211:d21_12:d21_121-d21_1211:d21_13
sum(HouseholdCambodia_2C$d211 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_12 != '')
for (i in c(1343:1356)){
  print(sum(HouseholdCambodia_2C$d211 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d211 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_13 != '')
#OK
#d212:d21_22:d21_221- d21_2211:d21_23
sum(HouseholdCambodia_2C$d212 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_22 != '')
for (i in c(1360:1373)){
  print(sum(HouseholdCambodia_2C$d212 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d212 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_23 != '')
#OK
#d213:d21_32:d21_321- d21_3211:d21_33
sum(HouseholdCambodia_2C$d213 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_32 != '')
for (i in c(1377:1390)){
  print(sum(HouseholdCambodia_2C$d213 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d213 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_33 != '')
#OK
#d214:d21_42:d21_421- d21_4211:d21_43
sum(HouseholdCambodia_2C$d214 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_42 != '')
for (i in c(1394:1407)){
  print(sum(HouseholdCambodia_2C$d214 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d214 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_43 != '')
#OK
#d215:d21_52:d21_521- d21_5211:d21_53
#No household implemented this practice
#d216:d21_62:d21_621- d21_6211:d21_63
sum(HouseholdCambodia_2C$d216 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_62 != '')
for (i in c(1428:1441)){
  print(sum(HouseholdCambodia_2C$d216 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d216 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_63 != '')
#OK
#d217:d21_72:d21_721- d21_7211:d21_73
sum(HouseholdCambodia_2C$d217 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_72 != '')
for (i in c(1445:1458)){
  print(sum(HouseholdCambodia_2C$d217 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d217 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_73 != '')
#OK
#d218:d21_82:d21_821- d21_8211:d21_83
#No household implemented this practice
#d219:d21_92:d21_921- d21_9211:d21_93
sum(HouseholdCambodia_2C$d219 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_92 != '')
for (i in c(1479:1492)){
  print(sum(HouseholdCambodia_2C$d219 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d219 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_93 != '')
#OK
#d2110:d21_102:d21_1021- d21_10211:d21_103
sum(HouseholdCambodia_2C$d2110 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_102 != '')
for (i in c(1496:1509)){
  print(sum(HouseholdCambodia_2C$d2110 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2110 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_103 != '')
#OK
#d2111:d21_112:d21_1121- d21_11211:d21_113
#No household implemented this practice
#d2112:d21_122:d21_1221- d21_12211:d21_123
sum(HouseholdCambodia_2C$d2112 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21122 != '')
for (i in c(1530:1543)){
  print(sum(HouseholdCambodia_2C$d2112 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2112 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d2112_3 != '')
#OK
#d2113:d21_132:d21_1321- d21_13211:d21_133
sum(HouseholdCambodia_2C$d2113 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_132 != '')
for (i in c(1547:1560)){
  print(sum(HouseholdCambodia_2C$d2113 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2113 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_133 != '')
#OK
#d2114:d21_142:d21_1421- d21_14211:d21_143
sum(HouseholdCambodia_2C$d2114 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_142 != '')
for (i in c(1564:1577)){
  print(sum(HouseholdCambodia_2C$d2114 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2114 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_143 != '')
#OK
#d2199:d21_992:d21_9921- d21_99211:d21_993
sum(HouseholdCambodia_2C$d2199 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_992 != '')
for (i in c(1580:1594)){
  print(sum(HouseholdCambodia_2C$d2199 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2199 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d21_993 != '')
#OK
#d2a_1:d2b_1:d2c_1:d24:d25
x <- HouseholdCambodia_2C[,c(1,590,600,611,1599,1600)]
#OK
#d2a_1:d2b_1:d2c_1:d26:d27:d271-d2799
x <- HouseholdCambodia_2C[,c(17,590,600,611,1601:1618)]
#OK
#d271:d27_11:d27_111-d27_1111:d27_12
sum(HouseholdCambodia_2C$d271 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_11 != '')
for (i in c(1621:1634)){
  print(sum(HouseholdCambodia_2C$d271 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d271 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_12 != '')
#OK
#d272:d27_21:d27_211- d27_2111:d27_22
#No household implemented this practice
#d273:d27_31:d27_311- d27_3111:d27_32
sum(HouseholdCambodia_2C$d273 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_31 != '')
for (i in c(1655:1668)){
  print(sum(HouseholdCambodia_2C$d272 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d273 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_32 != '')
#OK
#d274:d27_41:d27_411- d27_4111:d27_42
sum(HouseholdCambodia_2C$d274 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_41 != '')
for (i in c(1672:1685)){
  print(sum(HouseholdCambodia_2C$d274 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d274 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_42 != '')
#OK
#d275:d27_51:d27_511- d27_5111:d27_52
sum(HouseholdCambodia_2C$d275 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_51 != '')
for (i in c(1689:1702)){
  print(sum(HouseholdCambodia_2C$d275 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d275 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_52 != '')
#OK
#d276:d27_61:d27_611- d27_6111:d27_62
sum(HouseholdCambodia_2C$d276 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_61 != '')
for (i in c(1706:1719)){
  print(sum(HouseholdCambodia_2C$d276 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d276 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_62 != '')
#OK
#d277:d27_71:d27_711- d27_7111:d27_72
sum(HouseholdCambodia_2C$d277 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_71 != '')
for (i in c(1723:1736)){
  print(sum(HouseholdCambodia_2C$d277 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d277 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_72 != '')
#OK
#d278:d27_81:d27_811- d27_8111:d27_82
sum(HouseholdCambodia_2C$d278 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_81 != '')
for (i in c(1740:1753)){
  print(sum(HouseholdCambodia_2C$d278 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d278 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_82 != '')
#OK
#d279:d27_91:d27_911- d27_9111:d27_92
sum(HouseholdCambodia_2C$d279 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_91 != '')
for (i in c(1757:1770)){
  print(sum(HouseholdCambodia_2C$d279 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d279 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_92 != '')
#OK
#d2710:d27_101:d27_1011- d27_10111:d27_102
#No household implemented this practice
#d2711:d27_111:d27_1111- d27_11111:d27_112
sum(HouseholdCambodia_2C$d2711 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_111_a != '')
for (i in c(1791:1804)){
  print(sum(HouseholdCambodia_2C$d2711 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2711 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_112_a != '')
#OK
#d2712:d27_121:d27_1211- d27_12111:d27_122
#No household implemented this practice
#d2713:d27_131:d27_1311- d27_13111:d27_132
sum(HouseholdCambodia_2C$d2713 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_131 != '')
for (i in c(1825:1838)){
  print(sum(HouseholdCambodia_2C$d2713 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2713 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_132 != '')
# For 2 households, they declared '' to the practice but add a crop
#We'll replace '' by 'yes' in this case
HouseholdCambodia_2C$d2713 <- as.character(HouseholdCambodia_2C$d2713)
HouseholdCambodia_2C$d2713 <- ifelse(HouseholdCambodia_2C$d27_131 != '',1,HouseholdCambodia_2C$d2713)
HouseholdCambodia_2C$d2713 <- as.factor(HouseholdCambodia_2C$d2713)
#d2714:d27_141:d27_1411- d27_14111:d27_142
#No household implemented this practice
#d2799:d27_991:d27_9911- d27_99111:d27_992
sum(HouseholdCambodia_2C$d2799 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_991 != '')
for (i in c(1876:1889)){
  print(sum(HouseholdCambodia_2C$d2799 == 1, na.rm = T)-sum(!is.na(HouseholdCambodia_2C[,i])))
}
sum(HouseholdCambodia_2C$d2799 == 1, na.rm = T)-sum(HouseholdCambodia_2C$d27_992 != '')
#d2a_1:d2b_1:d2c_1:d30_1:d30_2:d30_21-d30_211
x <- HouseholdCambodia_2C[,c(1,590,600,611,1894:1909)]
#OK
#d2a_1:d2b_1:d2c_1:d30_3:d30_4:d30_41-d30_411
x <- HouseholdCambodia_2C[,c(1,590,600,611,1910:1925)]
#OK
#d2a_1:d2b_1:d2c_1:d30_5:d30_6:d30_61-d30_611
x <- HouseholdCambodia_2C[,c(1,590,600,611,1926:1941)]
#OK
#d2a_1:d2b_1:d2c_1:d32:d32_1:d32_11-d32_111
x <- HouseholdCambodia_2C[,c(1,590,600,611,1942:1957)]
#OK
#d32:d32_2
x <- HouseholdCambodia_2C[,c(1,1942,1958)]
#OK
#d2a_1:d2b_1:d2c_1:d33_1 :d33_10-d33_13
x <- HouseholdCambodia_2C[,c(1,590,600,611,1960:1964)]
#OK
#d2a_1:d2b_1:d2c_1:d33_2 :d33_20:d33_23
x <- HouseholdCambodia_2C[,c(1,590,600,611,1965:1969)]
#OK
#d2a_1:d2b_1:d2c_1:d33_3 :d33_30:d33_33
x <- HouseholdCambodia_2C[,c(1,590,600,611,1970:1974)]
#OK
#d2a_1:d2b_1:d2c_1:d33_4:d33_40:d33_43
x <- HouseholdCambodia_2C[,c(1,590,600,611,1975:1979)]
#OK
#d2a_1:d2b_1:d2c_1:d33_5 :d33_50:d33_53
x <- HouseholdCambodia_2C[,c(1,590,600,611,1980:1984)]
#OK
#d2a_1:d2b_1:d2c_1:d33_6 :d33_60:d33_63
x <- HouseholdCambodia_2C[,c(1,590,600,611,1791:1795)]
#OK
#d2a_1:d2b_1:d2c_1:d33_7 :d33_70:d33_73
x <- HouseholdCambodia_2C[,c(1,590,600,611,1990:1994)]
#OK
#d2a_1:d2b_1:d2c_1:d33_8:d33_80:d33_83
x <- HouseholdCambodia_2C[,c(1,590,600,611,1995:1999)]
#OK
#d2a_1:d2b_1:d2c_1:d33_9:d33_90:d33_93
x <- HouseholdCambodia_2C[,c(1,590,600,611,2000:2004)]
#OK
#d2a_1:d2b_1:d2c_1:d33_10:d33_100:d33_103
x <- HouseholdCambodia_2C[,c(1,590,600,611,2005:2009)]
#OK
#d2a_1:d2b_1:d2c_1:d33_11:d33_110:d33_113
x <- HouseholdCambodia_2C[,c(1,590,600,611,2010:2014)]
#OK
#d2a_1:d2b_1:d2c_1:d34:d35
x <- HouseholdCambodia_2C[,c(1,590,600,611,2015:2016)]
#OK
#d2a_1:d2b_1:d2c_1:d36:d361-d3699
x <- HouseholdCambodia_2C[,c(1,590,600,611,2017:2028)]
#OK
#e1 :e2 :e2_1 :e2_99
#OK
#e1 :e2_1 :e3_1:e3_2
x <- HouseholdCambodia_2C[,c(1,2030,2032,2047,2048)]
#OK
#e1 :e2_2 :e3_3:e3_4
x <- HouseholdCambodia_2C[,c(1,2030,2033,2049,2050)]
#OK
#e1 :e2_3 :e3_5:e3_6
x <- HouseholdCambodia_2C[,c(1,2030,2034,2051,2052)]
#OK
#e1 :e2_4 :e3_7:e3_8
x <- HouseholdCambodia_2C[,c(1,2030,2035,2053,2054)]
#OK
#e1 :e2_5 :e3_9:e3_10
x <- HouseholdCambodia_2C[,c(1,2030,2036,2055,2056)]
#OK
#e1 :e2_6 :e3_11
x <- HouseholdCambodia_2C[,c(1,2030,2037,2057)]
#OK
#e1 :e2_7 :e3_12
x <- HouseholdCambodia_2C[,c(1,2030,2038,2058)]
#OK
#e1 :e2_8 :e3_13
x <- HouseholdCambodia_2C[,c(1,2030,2039,2059)]
#OK
#e1 :e2_9 :e3_14
x <- HouseholdCambodia_2C[,c(1,2030,2040,2060)]
#OK
#e1 :e2_10 :e3_15
x <- HouseholdCambodia_2C[,c(1,2030,2041,2060)]
#OK
#e1 :e2_11 :e3_16
x <- HouseholdCambodia_2C[,c(1,2030,2042,2061)]
#OK
#e1 :e2_98 :e3_98
x <- HouseholdCambodia_2C[,c(1,2030,2043,2062)]
#OK
#e1 :e2_99 :e3_99
x <- HouseholdCambodia_2C[,c(1,2030,2044,2063)]
#OK
#e1:e4_1:e5_a:e5_b:e5_2:e5_1-e5_4:e5_5:b18_1:b19_1:b20_1:b20_10:b20_188:b21_1
x <- HouseholdCambodia_2C[,c(1,2030,2064,2070:2071,2075:2076,2078,2081,2084,2087:2097,2099)]
#OK
#e5_4:e5_41
x <- HouseholdCambodia_2C[,c(1,2078,2079)]
#OK
#e5_5:e5_51
x <- HouseholdCambodia_2C[,c(1,2082,2083)]
#OK
#e1:e4_2:e6_a:e6_b:e6_1-e6_5:b18_2:b19_2:b20_2:b21_2
x <- HouseholdCambodia_2C[,c(1,2030,2066,2100:2101,2105,2108,2114,2117,2118,2120)]
#OK
#e6_4:e6_41
x <- HouseholdCambodia_2C[,c(1,2108,2109)]
#OK
#e6_5:e6_51
x <- HouseholdCambodia_2C[,c(1,2111,2112)]
#OK
#e1:e4_3:e7_a:e7_b:e7_2:e7_1-e7_4:e7_5
x <- HouseholdCambodia_2C[,c(1,2030,2121,2122,2123,2126:2129)]
#OK
#e7_4:e7_41
x <- HouseholdCambodia_2C[,c(1,2129,2130)]
#OK
#e8:e9:e10
x <- HouseholdCambodia_2C[,c(1,2135:2137)]
#OK
#e12_1:e12_2
x <- HouseholdCambodia_2C[,c(1,2138:2139)]
#OK
#e7_5:e7_51
x <- HouseholdCambodia_2C[,c(1,2132,2133)]
#OK
#e12_3:e12_4
x <- HouseholdCambodia_2C[,c(1,2140:2141)]
#OK
#e12_5:e12_6
x <- HouseholdCambodia_2C[,c(1,2142:2143)]
#OK
#e13:e13_1
x <- HouseholdCambodia_2C[,c(1,2144:2145)]
#OK
#e2_1 :e2_2:e16:e17:e18:e19:e191-e1999
x <- HouseholdCambodia_2C[,c(1,2032:2033,2049:2050,2148:2166)]
#OK
#e2_1 :e2_2:e21:e22:e23:e24:e241-e2499
x <- HouseholdCambodia_2C[,c(1,2032,2033,2168:2186)]
#OK
#e2_1 :e2_2:e25:e26
x <- HouseholdCambodia_2C[,c(1,2032,2033,2188,2194)]
#OK
#e25:e25_1:e25_11-e25_199
x <- HouseholdCambodia_2C[,c(1,2188,2189:2193)]
#OK
#e26:e26_1:e26_11-e26_199
x <- HouseholdCambodia_2C[,c(1,2194,2195)]
#OK
#e26:e27:e270-e272:e27a_1
x <- HouseholdCambodia_2C[,c(1,2194,2196:2200)]
#OK
#e2_1:e2_2:e28
x <- HouseholdCambodia_2C[,c(1,2032,2033,2204)]
#OK
#e2_1:e2_2:e29:e29_1:e21_11:e29_10
x <- HouseholdCambodia_2C[,c(1,2032,2033,2205:2209)]
#OK
#e2_3:e30:e31:e32:e33:e34:e341-e3499
x <- HouseholdCambodia_2C[,c(1,2034,2214,2216:2234)]
#OK
#e30:e35:e36:e37:e38:e381-38499
x <- HouseholdCambodia_2C[,c(1,2034,2235:2253)]
#OK
#e30:e39
x <- HouseholdCambodia_2C[,c(1,2214,2255)]
#OK
#e39:e39_1:e39_11-e39_199
x <- HouseholdCambodia_2C[,c(2255:2260)]
#OK
#e30:e40
x <- HouseholdCambodia_2C[,c(1,2214,2261)]
#OK
#e40:e40_1:e41:e410:e412
x <- HouseholdCambodia_2C[,c(1,2261:2266)]
#OK
#e30:e42
x <- HouseholdCambodia_2C[,c(1,2214,2271)]
#OK
#e42 :e43
x <- HouseholdCambodia_2C[,c(1,2271,2272)]
#OK
#e43:e43_1:e43_11-e43_10
x <- HouseholdCambodia_2C[,c(1,2272:2277)]
#OK
#e2_8 :e44:e45:e46:e47:e48:e481-e4899
x <- HouseholdCambodia_2C[,c(1,2039,2281,2283:2301)]
#For some households we have no information about their raising systems
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#For other households, there are information but they are no raising chicken, we remove these informations
for (i in c(2039,2281,2283:2301)){
  HouseholdCambodia_2C[,i] <- as.character(HouseholdCambodia_2C[,i])
  HouseholdCambodia_2C[,i] <- ifelse(HouseholdCambodia_2C$e2_8 == 0, '', HouseholdCambodia_2C[,i])
  HouseholdCambodia_2C[,i] <- as.factor(HouseholdCambodia_2C[,i])
}
#e2_8:e49:e50:e51:e52:e521-e5299:e53:e54:e56
x <- HouseholdCambodia_2C[,c(1,2039,2302:2320,2322,2328,2330)]
#For some households we have no information about their raising systems
#As we cannot know their answer, we cannot solve this issue -> ASK ENUM
#For other households, there are information but they are no raising chicken, we remove these informations
for (i in c(2039,2302:2320,2322,2328,2330)){
  HouseholdCambodia_2C[,i] <- as.character(HouseholdCambodia_2C[,i])
  HouseholdCambodia_2C[,i] <- ifelse(HouseholdCambodia_2C$e2_8 == 0, '', HouseholdCambodia_2C[,i])
  HouseholdCambodia_2C[,i] <- as.factor(HouseholdCambodia_2C[,i])
}
#e53:e53_1:e53_11-e53_199
x <- HouseholdCambodia_2C[,c(1,2322:2327)]
#OK
#e54:e54_1:e55:e550-e552
x <- HouseholdCambodia_2C[,c(1,2328:2335)]
#OK
#e56:e57
x <- HouseholdCambodia_2C[,c(1,2339,2340)]
#OK
#e57:e57_1:e57_11-e57_10
x <- HouseholdCambodia_2C[,c(1,2340:2345)]
#OK
#e2_1,e2_2,e58
x <- HouseholdCambodia_2C[,c(1,2033,2034,2349)]
#OK
#e58:e58_1:e58_11-e58_112
x <- HouseholdCambodia_2C[,c(1,2349:2362)]
#OK
#e1,e59
x <- HouseholdCambodia_2C[,c(1,2030,2363)]
#OK
#e59:e59_1:e59_11:e59_112
x <- HouseholdCambodia_2C[,c(1,2363:2376)]
#OK
#e1:e60
x <- HouseholdCambodia_2C[,c(1,2030,2377)]
#OK
#h4_1:h4_11-h4_188
x <- HouseholdCambodia_2C[,c(1,2394:2400)]
#OK
...
x <- dplyr::count(HouMemberCambodia_2C, hhid_re1)
...
#is corresponding with the other table
x <- dplyr::count(ClowlandCambodia_2C, hhid_re2)
...
#d2_237a - 45000 to remove as it is an error: REMOVE
CuplandCambodia_2$d2_237a <- as.character(CuplandCambodia_2$d2_237a)
CuplandCambodia_2$d2_237a <- ifelse(CuplandCambodia_2$d2_237a == 45000, 1, CuplandCambodia_2$d2_237a)
CuplandCambodia_2$d2_237a <- as.numeric(CuplandCambodia_2$d2_237a)
summary(CuplandCambodia_2$d2_237a)

#d2_238 - 350 to remove as it is an error: REMOVE
CuplandCambodia_2$d2_238 <- as.character(CuplandCambodia_2$d2_238)
CuplandCambodia_2$d2_238 <- ifelse(CuplandCambodia_2$d2_238 == 350, 1, CuplandCambodia_2$d2_238)
CuplandCambodia_2$d2_238 <- as.numeric(CuplandCambodia_2$d2_238)
summary(CuplandCambodia_2$d2_238)

# # #c. Corresponding fields
#Everything is ok in the table, we'll just check if number of crops
#is corresponding with the other table
x <- dplyr::count(CuplandCambodia_2, hhid_re3)
...
#Everything is ok in the table, we'll just check if number of crops
#is corresponding with the other table
x <- dplyr::count(HomegardenCambodia_2, hhid_re4)
y <- HouseholdCambodia_2C[,c(1,611)]
G <- merge(x, y, by.x = "hhid_re4", by.y = "o9", all.x = T, all.y= T, sort = TRUE)
G$check <- G$n - G$no_crop3
#OK
